<?php
/**
 * COmanage Registry Petition Attribute Helper
 *
...
class PetitionAttributeHelper extends AppHelper {

  /**
   * Retrieve Co Petition MOU Transfer Attributes
   *
   * @since  COmanage Registry v4.1.0
   * @param  int $wedgeId    Wedge Plugin Id
   * @param  int $petitionId Petition Id
   * @return array LigoMouTransferPetition
   */

  public function retrieveTranserChoices($wedgeId, $petitionId) {
